...
#            pct_correct_notdogs - percentage of correctly classified NON-dogs
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1: 
            ...
            if results_dic[key][2] == 1:
                # Pet Image Label and Classifier Label match 
                results_stats_dic['n_correct_breed'] += 1
        
        else: 
            # Pet Image Label is NOT Dog if results_dic[key][3] == 0
            # number of Not Dog Images
            results_stats_dic['n_notdogs_img'] += 1
            
            if results_dic[key][4] == 0: 
                # Classifier Lable is NOT Dog
                # number of Correct Non-Dog matches
                results_stats_dic['n_correct_notdogs'] += 1
                
                
        """Calculating of the Percentages from the Results Statistics dictionary counts:          
         pct_match : percentage of correct matches"""
